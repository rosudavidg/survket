  ...
  return (
    <div className="terms-container">
      <div className="terms-content">
        ...
        <p>Welcome to survket!</p>

        <p>
          These terms and conditions outline the rules and regulations for the use of Survket's Website, located at
          www.survket.davidrosu.tech.
        </p>

        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use survket if
        ...
        <p>
          We employ the use of cookies. By accessing survket, you agreed to use cookies in agreement with the Survket's
          Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Survket and/or its licensors own the intellectual property rights for all material on
          survket. All intellectual property rights are reserved. You may access this from survket for your own personal
          use subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from survket</li>
          <li>Sell, rent or sub-license material from survket</li>
          <li>Reproduce, duplicate or copy material from survket</li>
          <li>Redistribute content from survket</li>
        </ul>
        ...
        <p>
          ...
          areas of the website. Survket does not filter, edit, publish or review Comments prior to their presence on the
          website. Comments do not reflect the views and opinions of Survket,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
          applicable laws, Survket shall not be liable for the Comments or for any liability, damages or expenses caused
          and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
        </p>

        <p>
          Survket reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>
          You hereby grant Survket a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>
          ...
          Survket; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to Survket. Please include your name, your organization name, contact
        ...
        <p>
          No use of Survket's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
      ...
      {accepted ? (
        <>
          <div className="terms-accept-text">Accepted</div>
          <input id="terms-back" className="terms-back" type="button" value="Back" onClick={history.goBack}></input>
        </>
      ) : (
        <input id="terms-accept" className="terms-accept" type="button" value="Accept" onClick={onClickAccept}></input>
      )}
    </div>
  );
};
